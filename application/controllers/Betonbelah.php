<?php
  ...
  * 
  */
 class Betonbelah extends CI_Controller
 {
	...
	public function display(){
		...
		$data['main_admin'] = "backend/betonbelah/display";
		$this->load->view('layouts/dashboard',$data);
	}

	public function addBetonbelah(){
		...
		if($this->form_validation->run()==FALSE){
			...
			$data['main_admin'] = "backend/betonbelah/addBetonbelah";
			$this->load->view('layouts/dashboard',$data);
		}
	}
	...
	public function store(){
		...
		if ($this->form_validation->run()==FALSE) {
			...
			if ($this->material_model->create_betonbelah($data)) {
				$this->session->set_flashdata('material_create','Sukses Tambah Material');
				redirect('Betonbelah/display');
			}
	...
	public function delete($id){
		...
		$this->material_model->delete_betonbelah($id);
		$this->session->set_flashdata('material_delete','Hapus data sukses');
		redirect('Betonbelah/display');
	}

	public function update($betonbelah_id){
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$data['data_betonbelah'] = $this->material_model->get_betonbelah_info($betonbelah_id);

			$data['main_admin'] = "backend/betonbelah/editBetonbelah";
			...
			if ($this->material_model->edit_betonbelah($betonbelah_id,$data)) {
