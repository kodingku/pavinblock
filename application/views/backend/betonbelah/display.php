...
<a href="<?php echo base_url()?>Betonbelah/addBetonbelah" class="btn btn-md u-btn-3d u-btn-teal g-mr-10 g-mb-15">+ Data Beton Belah</a>
...
<table id="material" class="display" width="100%">
    ...
    <tbody>
    	 <?php foreach($data_betonbelah as $value) { ?>
    	<tr class="text-center">
    		<td><?php echo $value->tebal; ?></td>
    		<td><?php echo number_format($value->harga); ?></td>
    		<td><?php echo $value->isi; ?></td>
        <td>
          <a href="<?php echo base_url()?>Betonbelah/update/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-orange g-mr-10 g-mb-15">Edit</a>
          <a href="<?php echo base_url()?>Betonbelah/delete/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-red g-mr-10 g-mb-15">Hapus</a>
        </td>
    	</tr>	
    	<?php } ?>
    </tbody>	
