...
<a href="<?php echo base_url()?>Trihex/addTrihex" class="btn btn-md u-btn-3d u-btn-teal g-mr-10 g-mb-15">+ Data Batako Press</a>
...
<table id="material" class="display" width="100%">
    ...
    <tbody>
    	 <?php foreach($data_trihex as $value) { ?>
    	<tr class="text-center">
        ...
        <td>
          <a href="<?php echo base_url()?>Trihex/update/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-orange g-mr-10 g-mb-15">Edit</a>
          <a href="<?php echo base_url()?>Trihex/delete/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-red g-mr-10 g-mb-15">Hapus</a>
        </td>
    	</tr>	
    	<?php } ?>
    </tbody>	
