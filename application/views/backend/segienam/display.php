...
<a href="<?php echo base_url()?>Segienam/addSegienam" class="btn btn-md u-btn-3d u-btn-teal g-mr-10 g-mb-15">+ Data Grass Block</a>
...
<table id="material" class="display" width="100%">
    ...
    <tbody>
    	 <?php foreach($data_segienam as $value) { ?>
    	<tr class="text-center">
        ...
        <td>
          <a href="<?php echo base_url()?>Segienam/update/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-orange g-mr-10 g-mb-15">Edit</a>
          <a href="<?php echo base_url()?>Segienam/delete/<?php echo $value->id_pavin ?>" class="btn btn-md u-btn-red g-mr-10 g-mb-15">Hapus</a>
        </td>
    	</tr>	
    	<?php } ?>
    </tbody>	
